//
//  SSAComponentGoodsDetailCategory.swift
//  Pods-SSAComponentGoodsDetailCategory_Example
//
...
public extension CTMediator {
    @objc func goToGoodsDetailsVC4Swift(callback:@escaping (String) -> Void,goodsId: String!,goodsName: String!) -> UIViewController? {
        let params = [
            "callback":callback,
            "goodsId":goodsId,
            "goodsName":goodsName,
    ...
    @objc func goToGoodsDetailsVC4OC(callback:@escaping (String) -> Void,goodsId: String!,goodsName: String!) -> UIViewController? {
